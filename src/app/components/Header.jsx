  ...
  return (
    <header className="sticky top-0 md:z-50 z-10 bg-[#22024E] text-white">
      <div className="container mx-auto flex items-center justify-between py-5 px-6">
        <div className="font-[montserratSemiBold] text-lg flex gap-2"><img src="/pakwheels.png" className="w-8 animate-spin-circle" /> <img src="/download.png" className="w-10" /> VEHICLE VIN</div>
